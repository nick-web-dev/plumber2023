...
.factory('Fabric', [
	...
	return function(options) {
        ...
        fabric.Object.prototype.customiseCornerIcons( {
            ...
            tl: {
                icon: 'http://volive.in/artaholics_dev/assets/design/images/icons/rotate.jpg'
            },
            tr: {
                icon: 'http://volive.in/artaholics_dev/assets/design/images/icons/resize.jpg'
            },
            bl: {
                icon: 'http://volive.in/artaholics_dev/assets/design/images/icons/delete.png'
            },
            br: {
                icon: 'http://volive.in/artaholics_dev/assets/design/images/icons/move.jpg'
            },
            mb: {
                icon: 'http://volive.in/artaholics_dev/assets/design/images/icons/move.jpg'
            },
       ...
       /***************** for corner icons  ****************/
        ...
        self.downloadCanvasObject = function() {
            ...
            $.ajax({
                method: 'post',
                url: "http://volive.in/artaholics_dev/Design/get_canvas_image",
                data: {'data':data},
