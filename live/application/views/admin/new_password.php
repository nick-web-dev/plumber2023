...
<head>
	...
	<!-- Favicon icon -->
	<link rel="shortcut icon" href="<?php echo base_url();?>assets/website/img/logo.png"  type="image/x-icon">
	<link rel="icon" href="<?php echo base_url();?>assets/website/img/logo.png"  type="image/x-icon">
	<!-- Font Awesome -->
				...
				<div class="login-card card-block">
					<form class="md-float-material" id="loginform" method="POST" action="<?php echo base_url();?>home/change_password">
						<div class="text-center">
							<img src="<?php echo base_url();?>assets/website/img/logo.png" style="width:84%;margin-left:-85px;height:  114px;">
						</div>
