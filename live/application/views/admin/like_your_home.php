...
<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header"><h5 class="card-header-text">Like Your Home</h5>
          </div>
        <div class="card-block">
          <form id="edit_term" method="post">
            ...
            <label for="example-tel-input" class="col-xs-2 col-form-label form-control-label">Image</label>
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="data[title1]" value="<?php echo @$terms[0]['title1']; ?>" placeholder="Title 2">
                </div>
                </div>
                   <div class="form-group row">
    ...
    $('.edit_term').click(function(){     
        var validator = $("#edit_term").validate();       
            ...
            if(validator.form() == true){     
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_home_content",
                    type: "POST",
                    data: data,
