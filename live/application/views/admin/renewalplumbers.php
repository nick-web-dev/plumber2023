...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">        
        <div class="card">
          <div class="card-header"><h2 class="card-header-text" style="font-size: 21px;">Renewal Plumbers</h2><span></div>
        ...
        // //$dd = $check_user['created_date'];
                          ...
                          else
                          {
                            ...
                            $month= date('M', strtotime($key['payment_date']));
          $day  = date('d', strtotime($key['payment_date']));
          $year=date('Y', strtotime($key['payment_date']));
          $date=$day.'-'.$month.'-'.$year;
                          ?>
                          ...
                          <td><?php echo ucwords($key["company_name"]);?></td>
						   ...
						   <td style="white-space: break-spaces;"><?php echo $key["mobile_no"];?></td> 
						     <td style="white-space: break-spaces;"><?php echo $date;?></td> 
