              ...
              <!--   <option data-countryCode="CV" value="+238">Cape Verde Islands (+238)</option>
               ...
               <option data-countryCode="VU" value="+678"<?php  if(@$value['country_code'] == "+678"){ echo "selected";} ?>><?php echo "Vanuatu (+678)";?></option>
                ...
                <option data-countryCode="ZW" value="+263"<?php  if(@$value['country_code'] == "+263"){ echo "selected";} ?>><?php echo "Zimbabwe (+263)";?></option>
				 ...
				 <div class="form-group row">
                            <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Map Location <span style="color:red">*</span> </label>
							<div class="col-sm-9">
                            <input  placeholder="Search your Location" name="data[address]" id="address" value="<?php echo @$value['address'] ?>" class="form-control"  type="text">
                         </div>
                </div>
				 <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="data[state]" id="state" value="<?php echo @$value['state']?>">
                    </div>
                </div>
                 <div class="form-group row">
				  ...
				  <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Type of Plumbing <span style="color:red">*</span></label>
                    <div class="col-sm-9">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="data[zip_code]" id="zip_code" value="<?php echo @$value['zip_code']?>">
                    </div>
                </div>
                 <div class="form-group row">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAC9RuigAHsx7QDLc-t41UhtGBCkoyrxDE&libraries=places&callback=initAutocomplete" async defer></script>
