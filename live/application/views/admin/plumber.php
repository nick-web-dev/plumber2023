...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">        
        <div class="card">
          <div class="card-header"><h2 class="card-header-text" style="font-size: 21px;">Plumbers</h2><span>
           <!--<a href="<?php echo base_url()?>admin/addplumber"><button class="btn btn-success fa fa-plus" style="margin-left:85%;margin-top: -25px;">Add Plumber</button></a></span>-->
                      ...
                      {   
                          ...
                          <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                            <div class="btn-group btn-group-sm" style="float: none;">
                              <div class="btn-group btn-group-sm" style="float: none;"> 
                                <a href="<?= base_url()?>admin/view_plumber_details/<?php echo base64_encode($key['user_id']);?>"><button type="button" class="btn btn-primary waves-effect waves-light"> 
