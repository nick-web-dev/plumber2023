...
<head>
<meta charset="utf-8">
<title>New Plumber Registered</title>
...
<div class="main-div"  style="margin:20px auto; height:auto;border: 1px solid #ccc;width: 184%;">
  <div class="content" style="width:100%; margin:0px auto;">
    <div class="top-header" style="width: 100%;padding-bottom: 100px;padding-top: 10px;background: #ffd600  !important;border-bottom: 1px solid #ccc;">
      ...
      <h3 class="" style="margin-bottom: 0px;font-size: 25px;color: white !important;font-weight: 600;line-height: 18px;margin-top: 35px;  text-transform: uppercase;text-align: center;">New Plumber Registered</h3>
    ...
    float: left;    padding-left: 20px;">{email}</p>
       <div class="clearifx" style="clear:both"></div>
         <p style="margin-bottom: 0px;text-align:center;width: 25%;
    float: left;"><strong>Phone Number</strong><span style="width: 10%;
    float: right;">:</span></p>
      <p style="text-align:left;width: 70%;
    float: left;    padding-left: 20px;">{mobile_no}</p>
       <div class="clearifx" style="clear:both"></div>
       
        <p style="margin-bottom: 0px;text-align:center;width: 25%;
    float: left;"><strong>Company Name</strong><span style="width: 10%;
    float: right;">:</span></p>
      <p style="text-align:left;width: 70%;
    float: left;    padding-left: 20px;">{company_name}</p>
       <div class="clearifx" style="clear:both"></div>
      </div>
