...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">        
        <div class="card">
          <div class="card-header"><h5 class="card-header-text"><?php echo @$current_page; ?></h5><span>
           <!-- <a href="<?php echo base_url()?>admin/add_service"><button class="btn btn-primary waves-effect waves-light pull-right add_product_category1" style="margin-left:65%">Add Service</button></a></span></div>-->
		    <span><button type="button" class="btn btn-success fa fa-plus add_banners" data-name="<?php echo @$current_page; ?>" style="margin-left:81%;"> Add Advertisement</button></span>
              </div>
...
//alert(id);	  
      ...
      $modal.load('<?php echo site_url('admin/add_advertisements');?>', {id: id},
      function(){
      $modal.modal('show');
      });
    }); 
 	 ...
 	 <script>     
       ...
       $('.delete_product_category').on('click',function(event){ 
			...
			var table="advertisements";
             var param="id";
              alertify.confirm("Do you want to delete this advertisement?",
              function(){
              $.ajax({                
