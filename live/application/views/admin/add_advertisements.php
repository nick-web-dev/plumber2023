...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Advertisement</h4>
        </div>
        <div class="modal-body">
            <form id="insert_banners">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <img src="<?php echo base_url().$value->image?>" width="150px" height="100px" style="background-color:gray;">
                    </div>
                </div>
                <?php } ?>
                <div class="form-group row">
    ...
    $('.insert_banners').click(function(){     
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){     
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_advertisements",
                    type: "POST",
                    data: data,
