        ...
        <div class="row">
          ...
          <div class="col-md-9 col-sm-12">
            <div class="">
              ...
              <button type="button" class="btn add_banners1 mb-0 mt-1 call-button" data-id="<?php echo base64_encode($plumb['user_id']); ?>" data-phone="<?=$plumb['country_code'].$plumb['mobile_no'] ?>"><span style="color:red !important">Call this Plumber</span></button>
