            ...
            <div class="vs_plumber_create_from_w">
              <div class="form-group">
                <label><h6>  Company Name  </h6></label>
                  <input type="text" class="form-control" id="company_name" placeholder="" name="data[company_name]">
                      <input type="hidden" name="user_id" id="user_id" value="<?php echo $user_id;?>" class="form-control">
                </div>
                <div class="form-group">
                  <label><h6>  E-mail Address  </h6></label>
                  <input type="email" class="form-control" id="email" placeholder="" name="data[email]"  onchange="check_email(this.value)">
                      <span id="error_message" style="color:red"></span> 
                </div>
                  <div class="form-group">
                  <label><h6> Profile Picture </h6></label>
                  <input type="file" class="form-control"  name="user_image" id="user_image" onchange="validateLogo()"  id="customFile1" accept='image/*'>
                ...
                <div class="row row-100">
                    <div class="col">
                      ...
                      <input type="text" class="form-control" id="Hours" placeholder="Mon-Fri 9am-5pm" name="data[open_hours]">
                    </div>
                    <div class="col">
                      <label><h6> Emergency Service  </h6></label>
                      <input type="text" class="form-control" id="emergency_service" placeholder="Emergency Service" name="data[emergency_service]">
              ...
              <!--          </select>-->
                  ...
                  <div class="row typeOfPlumber">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="data[type_of_plumbling][]" value="<?php echo $typeofplumbing['id']?>">
                ...
                <div class="form-group">
                  <label class="py-3"><h6>Company Description</h6></label>
                    <textarea type="text" class="form-control pt-2" rows="8" placeholder="" name="data[company_description]"></textarea>
                </div>
                <div class="row row-100">
                    <div class="col">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="Number" placeholder="" name="data[number_of_tracks]" onkeyup="Accept_OnlyNumbers(this,false,'contactnum_error')">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Search your Location" name="data[address]" id="address">
                </div>
                <div class="form-group">
                ...
                <div class="row row-100">
                    <div class="col">
                      ...
                      <input type="text" class="form-control"name="data[city]"  id="locality">
                                    ...
                                    <input type="hidden" name="data[latitude]"  id="latitude" class="form-control" placeholder="latitude" >
                                    <input type="hidden" name="data[longitude]" id="longitude" class="form-control" placeholder="longitude">
                                  <input class="form-control" type="hidden" placeholder="Street Address" name="data[street]" id="street_number">
        
                    </div>
                    <div class="col">
                      <label><h6> State  </h6></label>
                      <input type="text" class="form-control" placeholder="" name="data[state]">
                    </div>
                </div>
                <div class="row row-100">
                    <div class="col">
                      <label><h6>  Zip Code  </h6></label>
                      <input type="text" class="form-control" id="Code" placeholder="" name="data[zip_code]">
                    </div>
                    <div class="col">
                ...
                <div>
                   <div>
                                <div id="dealer_map" style="height:296px;margin-left:3px; border: 2px solid ;" width="100%" height="300" >
                                </div>
                ...
                <label><h6>  Password </h6></label>
                  <input type="Password" class="form-control" id="password" placeholder="" name="data[password]">
                </div>
                <div class="form-group">
                ...
                <div class="form-check pl-0">
                  ...
                  <label class="form-check-label" for="inlineCheckbox1"><h6>I agree to have a 6 months free to start</h6></label>
              </div>
            </div>
