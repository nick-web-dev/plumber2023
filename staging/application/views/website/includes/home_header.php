	...
	<nav class="vs_responsive_navbar ">
  		<div class="vs_logo">
  			<a href="<?php echo base_url();?>">
                <img src="<?php echo base_url(); ?>assets/website/img/plumberlogo3.png" class="vs_full_logo img-fluid">
                <img src="<?php echo base_url(); ?>assets/website/img/plumberlogo3.png" class="vs_sticky_logo img-fluid">
            </a>
  		</div>
      	<div class="vs_inner-width">
          	...
          	<div class="vs_menu_list2">
                <div class="vs_menu_logo">
                  	<img src="<?php echo base_url() ?>assets/website/img/plumberlogo3.pn"class="img-fluid" width="150px">
                </div>
          ...
          ?>
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?php echo base_url(); ?>website/plumber_profile/<?php echo base64_encode($user_data['user_id']);?>">view Profile</a>
