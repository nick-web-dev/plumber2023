...
<style>
  ...
  .pagination-dive a:hover,
  .pagination-dive .active a {
    background: #ffd600;
  }
          ...
          <div class="vs_banner_head">
            ...
            <div class="vs_find_plmbr_cnt" style="margin-top: -32px;">
              ...
              <form class="common_form" method="post" enctype='multipart/form-data' action="<?php echo base_url() ?>website/search_plumber#vs_plumber_data" accept-charset="utf-8">
                <div class="vs_find_plumber plumbers_list_cstm">
                ...
                <div class="col-md-3 col-sm-12">
                  <div class="vs_plumber_database_left">
                    <?php if ($plumb['user_image']) { ?>
                      <img src="<?php echo base_url() . $plumb['user_image']; ?>" class="img-fluid">
                    <?php } else { ?>
                      <img src="<?php echo base_url() . "assets/uploads/weblogo.png"; ?>" class="img-fluid">
                    <?php } ?>
                  </div>
                </div>
                <div class="col-md-9 col-sm-12">
                  <div class="">
                    <h3 class="mt-3 mt-md-0 mb-0"><b><a href="<?php echo base_url() ?>website/plumber_profile/<?php echo base64_encode($plumb['user_id']); ?>"><?php echo $plumb['company_name'] ?></a></b></h3>
                    ...
                    <div class="d-flex">
                      ...
                      <!--div class="mr-md-5 mr-2">
                        <h6 class="mb-0"><b>Distance</b></h6>
                        <h6><?php //echo get_distance($plumb['latitude'], $plumb['longitude'], floatval(getCurrentLocation()[0]), floatval(getCurrentLocation()[1])) ?></h6>
                      </div-->
                    ...
                    <div class="d-md-flex">
                      <button class="btn mb-0 mt-1"><a href="<?php echo base_url(); ?>website/sendmessage/<?php echo base64_encode($plumb['user_id']); ?>">Send Message</a></button>
                      ...
                      <button class="btn mb-0 mt-1"><a href="<?php echo base_url(); ?>website/requestquote/<?php echo base64_encode($plumb['user_id']); ?>">Request a Quote </a></button>
                    </div>
...
<script>
  ...
  <?php
  /* function get_distance($latitudeTo, $longitudeTo, $latitudeFrom, $longitudeFrom)
  {

    // $latitudeFrom = 30.695202;
    // $longitudeFrom = 76.7794;
    ...
    return strval(round($miles, 2) . 'miles');
  }
  ...
  function getCurrentLocation()
  {
    ...
    if (!empty($result)) {
      ...
      echo 'This is else data not found';
