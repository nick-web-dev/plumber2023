...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Four Type</h4>
        </div>
            ...
            <form id="insert_banners">
               <div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Title</label>
                    <div class="col-sm-9">
                        <!--<textarea name="data[title]" id="title" rows="4" cols="3" class="form-control" placeholder="Title" ><?//=$value->title?></textarea>-->
                          <input type="text" name="data[title]" id="title" class="form-control" placeholder="Title" value="<?=@$value->title?>">
                    </div>
                </div>
                   <div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Text</label>
                    <div class="col-sm-9">
                        <!--<textarea name="data[title]" id="title" rows="4" cols="3" class="form-control" placeholder="Title" ><//?=$value->title?></textarea>-->
                          <input type="text" name="data[text]" id="text" class="form-control" placeholder="Text" value="<?=@$value->text?>">
                    </div>
                </div>
    ...
    $('.insert_banners').click(function(){     
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){     
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_four_types",
                    type: "POST",
                    data: data,
