...
angular.module('productApp', [
    ...
    function ($scope, Fabric, FabricConstants, Keypress, $http, $timeout, $mdDialog, $mdToast, Upload) {
        ...
        var SETTINGS_INIT_URL = "http://volive.in/artaholics_dev/assets/design/inc/json/settings.json";
        ...
        this.initProducts = function () {
            ...
            //console.log($scope.REQUEST_URL.LOAD_PRODUCTS); return ;

            $scope.productCategory = "all";
            $http({
                method: 'get',
                url: "http://volive.in/artaholics_dev/Design/get_costomised_products",
                dataType : 'json',
                headers: {'Content-Type': 'application/json'}
            }).success(function (data, status, headers, config) {
