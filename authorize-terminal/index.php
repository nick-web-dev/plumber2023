...
$customer_number      = ( ! empty( $_REQUEST["customer_number"] ) ) ? esc_str( $_REQUEST["customer_number"] ) : '';
...
<?php } ?>
    ...
    <div align="center" class="wrapper">
        ...
        <div class="form_container">
            ...
            <h1>Calltheplumber Payment Terminal</h1>
                ...
                <div id="accordion">
					...
					<?php if ( $show_form ) { ?>
                        ...
                        <div class="pane" style="display:block">
							...
							<?php if($enableCustomerID){ ?>

                                <div class="clr"></div>

                                <label>Customer Number:</label>

                                <input name="customer_number" id="customer_number" type="text" class="long-field"

                                       value="<?php echo sanitize( $customer_number ); ?>"
                        ...
                        <div class="pane">
                            ...
                            <input name="fname" id="fname" type="text" class="long-field"
                                   ...
                                   value="<?php echo sanitize( $fname ); ?>" onkeyup="checkFieldBack(this);"/>
                            ...
                            <input name="lname" id="lname" type="text" class="long-field"
                                   ...
                                   value="<?php echo sanitize( $lname ); ?>" onkeyup="checkFieldBack(this);"/>
                            ...
                            <input name="address" id="address" type="text" class="long-field"
                                   ...
                                   value="<?php echo sanitize( $address ); ?>" onkeyup="checkFieldBack(this);"/>
                            ...
                            <input name="city" id="city" type="text" class="long-field"
                                   ...
                                   value="<?php echo sanitize( $city ); ?>" onkeyup="checkFieldBack(this);"/>
                            ...
                            <select name="country" id="country" class="long-field" onchange="checkFieldBack(this);">
                                ...
                                <option value="US" <?php echo $country == "US" ? "selected" : "" ?>>United States

                                </option>

                                <option value="CA" <?php echo $country == "CA" ? "selected" : "" ?>>Canada</option>

                                <option value="UK" <?php echo $country == "UK" ? "selected" : "" ?>>United Kingdom
                                ...
                                <option value="AF" <?php echo $country == "AF" ? "selected" : "" ?>>Afghanistan
                                ...
                                <option value="AS" <?php echo $country == "AS" ? "selected" : "" ?>>American Samoa
                                ...
                                <option value="AQ" <?php echo $country == "AQ" ? "selected" : "" ?>>Antarctica

                                </option>

                                <option value="AG" <?php echo $country == "AG" ? "selected" : "" ?>>Antigua and
                                ...
                                <option value="AZ" <?php echo $country == "AZ" ? "selected" : "" ?>>Azerbaijan
                                ...
                                <option value="BD" <?php echo $country == "BD" ? "selected" : "" ?>>Bangladesh
                                ...
                                <option value="BA" <?php echo $country == "BA" ? "selected" : "" ?>>Bosnia and
                                ...
                                <option value="BF" <?php echo $country == "BF" ? "selected" : "" ?>>Burkina Faso
                                ...
                                <option value="CV" <?php echo $country == "CV" ? "selected" : "" ?>>Cape Verde

                                </option>

                                <option value="KY" <?php echo $country == "KY" ? "selected" : "" ?>>Cayman Islands
                                ...
                                <option value="CX" <?php echo $country == "CX" ? "selected" : "" ?>>Christmas
                                ...
                                <option value="CD" <?php echo $country == "CD" ? "selected" : "" ?>>Congo, The

                                    Democratic Republic of the

                                </option>

                                <option value="CK" <?php echo $country == "CK" ? "selected" : "" ?>>Cook Islands

                                </option>

                                <option value="CR" <?php echo $country == "CR" ? "selected" : "" ?>>Costa Rica

                                </option>

                                <option value="CI" <?php echo $country == "CI" ? "selected" : "" ?>>Cote D`Ivoire
                                ...
                                <option value="CZ" <?php echo $country == "CZ" ? "selected" : "" ?>>Czech Republic
                                ...
                                <option value="SV" <?php echo $country == "SV" ? "selected" : "" ?>>El Salvador

                                </option>

                                <option value="GQ" <?php echo $country == "GQ" ? "selected" : "" ?>>Equatorial
                                ...
                                <option value="FO" <?php echo $country == "FO" ? "selected" : "" ?>>Faroe Islands
                                ...
                                <option value="GF" <?php echo $country == "GF" ? "selected" : "" ?>>French Guiana
                                ...
                                <option value="GP" <?php echo $country == "GP" ? "selected" : "" ?>>Guadeloupe
                                ...
                                <option value="GW" <?php echo $country == "GW" ? "selected" : "" ?>>Guinea-Bissau
                                ...
                                <option value="IR" <?php echo $country == "IR" ? "selected" : "" ?>>Iran (Islamic
                                ...
                                <option value="KZ" <?php echo $country == "KZ" ? "selected" : "" ?>>Kazakhstan
                                ...
                                <option value="KP" <?php echo $country == "KP" ? "selected" : "" ?>>Korea North

                                </option>

                                <option value="KR" <?php echo $country == "KR" ? "selected" : "" ?>>Korea South

                                </option>

                                <option value="KW" <?php echo $country == "KW" ? "selected" : "" ?>>Kuwait</option>

                                <option value="KG" <?php echo $country == "KG" ? "selected" : "" ?>>Kyrgyzstan
                                ...
                                <option value="LI" <?php echo $country == "LI" ? "selected" : "" ?>>Liechtenstein
                                ...
                                <option value="LU" <?php echo $country == "LU" ? "selected" : "" ?>>Luxembourg

                                </option>

                                <option value="MO" <?php echo $country == "MO" ? "selected" : "" ?>>Macau</option>

                                <option value="MK" <?php echo $country == "MK" ? "selected" : "" ?>>Macedonia

                                </option>

                                <option value="MG" <?php echo $country == "MG" ? "selected" : "" ?>>Madagascar
                                ...
                                <option value="MQ" <?php echo $country == "MQ" ? "selected" : "" ?>>Martinique

                                </option>

                                <option value="MR" <?php echo $country == "MR" ? "selected" : "" ?>>Mauritania
                                ...
                                <option value="FM" <?php echo $country == "FM" ? "selected" : "" ?>>Micronesia
                                ...
                                <option value="MS" <?php echo $country == "MS" ? "selected" : "" ?>>Montserrat

                                </option>

                                <option value="MA" <?php echo $country == "MA" ? "selected" : "" ?>>Morocco</option>

                                <option value="MZ" <?php echo $country == "MZ" ? "selected" : "" ?>>Mozambique
                                ...
                                <option value="NL" <?php echo $country == "NL" ? "selected" : "" ?>>Netherlands

                                </option>

                                <option value="AN" <?php echo $country == "AN" ? "selected" : "" ?>>Netherlands

                                    Antilles

                                </option>

                                <option value="NC" <?php echo $country == "NC" ? "selected" : "" ?>>New Caledonia

                                </option>

                                <option value="NZ" <?php echo $country == "NZ" ? "selected" : "" ?>>New Zealand
                                ...
                                <option value="PS" <?php echo $country == "PS" ? "selected" : "" ?>>Palestine
                                ...
                                <option value="PH" <?php echo $country == "PH" ? "selected" : "" ?>>Philippines
                                ...
                                <option value="PR" <?php echo $country == "PR" ? "selected" : "" ?>>Puerto Rico
                                ...
                                <option value="RU" <?php echo $country == "RU" ? "selected" : "" ?>>Russian
                                ...
                                <option value="VC" <?php echo $country == "VC" ? "selected" : "" ?>>Saint Vincent and
                                ...
                                <option value="SM" <?php echo $country == "SM" ? "selected" : "" ?>>San Marino

                                </option>

                                <option value="SA" <?php echo $country == "SA" ? "selected" : "" ?>>Saudi Arabia

                                </option>

                                <option value="SN" <?php echo $country == "SN" ? "selected" : "" ?>>Senegal</option>

                                <option value="SC" <?php echo $country == "SC" ? "selected" : "" ?>>Seychelles

                                </option>

                                <option value="SL" <?php echo $country == "SL" ? "selected" : "" ?>>Sierra Leone
                                ...
                                <option value="SK" <?php echo $country == "SK" ? "selected" : "" ?>>Slovak Republic
                                ...
                                <option value="ZA" <?php echo $country == "ZA" ? "selected" : "" ?>>South Africa
                                ...
                                <option value="KN" <?php echo $country == "KN" ? "selected" : "" ?>>St. Kitts/Nevis

                                </option>

                                <option value="LC" <?php echo $country == "LC" ? "selected" : "" ?>>St. Lucia
                                ...
                                <option value="SZ" <?php echo $country == "SZ" ? "selected" : "" ?>>Swaziland

                                </option>

                                <option value="SE" <?php echo $country == "SE" ? "selected" : "" ?>>Sweden</option>

                                <option value="CH" <?php echo $country == "CH" ? "selected" : "" ?>>Switzerland
                                ...
                                <option value="TI" <?php echo $country == "TI" ? "selected" : "" ?>>Tajikistan
                                ...
                                <option value="TT" <?php echo $country == "TT" ? "selected" : "" ?>>Trinidad and
                                ...
                                <option value="TM" <?php echo $country == "TM" ? "selected" : "" ?>>Turkmenistan
                                ...
                                <option value="AE" <?php echo $country == "AE" ? "selected" : "" ?>>United Arab
                                ...
                                <option value="UZ" <?php echo $country == "UZ" ? "selected" : "" ?>>Uzbekistan
                                ...
                                <option value="VI" <?php echo $country == "VI" ? "selected" : "" ?>>Virgin Islands
                                ...
                                <option value="YU" <?php echo $country == "YU" ? "selected" : "" ?>>Yugoslavia
                            ...
                            <select name="state" id="state" class="long-field" onchange="checkFieldBack(this);">
                                ...
                                <optgroup label="Australian Provinces">
                                    ...
                                    <option value="-AU-NSW" <?php echo $state == "-AU-NSW" ? "selected" : "" ?>>New

                                        South Wales

                                    </option>

                                    <option value="-AU-QLD" <?php echo $state == "-AU-QLD" ? "selected" : "" ?>>
                                    ...
                                    <option value="-AU-TAS" <?php echo $state == "-AU-TAS" ? "selected" : "" ?>>

                                        Tasmania

                                    </option>

                                    <option value="-AU-VIC" <?php echo $state == "-AU-VIC" ? "selected" : "" ?>>
                                    ...
                                    <option value="-AU-ACT" <?php echo $state == "-AU-ACT" ? "selected" : "" ?>>

                                        Australian Capital Territory

                                    </option>

                                    <option value="-AU-NT" <?php echo $state == "-AU-NT" ? "selected" : "" ?>>
                                ...
                                <optgroup label="Canadian Provinces">
                                    ...
                                    <option value="AB" <?php echo $state == "AB" ? "selected" : "" ?>>Alberta

                                    </option>

                                    <option value="BC" <?php echo $state == "BC" ? "selected" : "" ?>>British

                                        Columbia

                                    </option>

                                    <option value="MB" <?php echo $state == "MB" ? "selected" : "" ?>>Manitoba

                                    </option>

                                    <option value="NB" <?php echo $state == "NB" ? "selected" : "" ?>>New Brunswick

                                    </option>

                                    <option value="NF" <?php echo $state == "NF" ? "selected" : "" ?>>Newfoundland
                                    ...
                                    <option value="NS" <?php echo $state == "NS" ? "selected" : "" ?>>Nova Scotia

                                    </option>

                                    <option value="NVT" <?php echo $state == "NVT" ? "selected" : "" ?>>Nunavut

                                    </option>

                                    <option value="ON" <?php echo $state == "ON" ? "selected" : "" ?>>Ontario

                                    </option>

                                    <option value="PE" <?php echo $state == "PE" ? "selected" : "" ?>>Prince Edward
                                    ...
                                    <option value="SK" <?php echo $state == "SK" ? "selected" : "" ?>>Saskatchewan
                                ...
                                <optgroup label="US States">
                                    ...
                                    <option value="AL" <?php echo $state == "AL" ? "selected" : "" ?>>Alabama

                                    </option>

                                    <option value="AK" <?php echo $state == "AK" ? "selected" : "" ?>>Alaska</option>

                                    <option value="AZ" <?php echo $state == "AZ" ? "selected" : "" ?>>Arizona

                                    </option>

                                    <option value="AR" <?php echo $state == "AR" ? "selected" : "" ?>>Arkansas

                                    </option>

                                    <option value="BVI" <?php echo $state == "BVI" ? "selected" : "" ?>>British

                                        Virgin Islands

                                    </option>

                                    <option value="CA" <?php echo $state == "CA" ? "selected" : "" ?>>California

                                    </option>

                                    <option value="CO" <?php echo $state == "CO" ? "selected" : "" ?>>Colorado

                                    </option>

                                    <option value="CT" <?php echo $state == "CT" ? "selected" : "" ?>>Connecticut

                                    </option>

                                    <option value="DE" <?php echo $state == "DE" ? "selected" : "" ?>>Delaware

                                    </option>

                                    <option value="FL" <?php echo $state == "FL" ? "selected" : "" ?>>Florida

                                    </option>

                                    <option value="GA" <?php echo $state == "GA" ? "selected" : "" ?>>Georgia
                                    ...
                                    <option value="IL" <?php echo $state == "IL" ? "selected" : "" ?>>Illinois

                                    </option>

                                    <option value="IN" <?php echo $state == "IN" ? "selected" : "" ?>>Indiana
                                    ...
                                    <option value="KY" <?php echo $state == "KY" ? "selected" : "" ?>>Kentucky

                                    </option>

                                    <option value="LA" <?php echo $state == "LA" ? "selected" : "" ?>>Louisiana

                                    </option>

                                    <option value="ME" <?php echo $state == "ME" ? "selected" : "" ?>>Maine</option>

                                    <option value="MP" <?php echo $state == "MP" ? "selected" : "" ?>>Mariana

                                        Islands

                                    </option>

                                    <option value="MPI" <?php echo $state == "MPI" ? "selected" : "" ?>>Mariana

                                        Islands (Pacific)

                                    </option>

                                    <option value="MD" <?php echo $state == "MD" ? "selected" : "" ?>>Maryland

                                    </option>

                                    <option value="MA" <?php echo $state == "MA" ? "selected" : "" ?>>Massachusetts

                                    </option>

                                    <option value="MI" <?php echo $state == "MI" ? "selected" : "" ?>>Michigan

                                    </option>

                                    <option value="MN" <?php echo $state == "MN" ? "selected" : "" ?>>Minnesota

                                    </option>

                                    <option value="MS" <?php echo $state == "MS" ? "selected" : "" ?>>Mississippi

                                    </option>

                                    <option value="MO" <?php echo $state == "MO" ? "selected" : "" ?>>Missouri

                                    </option>

                                    <option value="MT" <?php echo $state == "MT" ? "selected" : "" ?>>Montana

                                    </option>

                                    <option value="NE" <?php echo $state == "NE" ? "selected" : "" ?>>Nebraska

                                    </option>

                                    <option value="NV" <?php echo $state == "NV" ? "selected" : "" ?>>Nevada</option>

                                    <option value="NH" <?php echo $state == "NH" ? "selected" : "" ?>>New Hampshire

                                    </option>

                                    <option value="NJ" <?php echo $state == "NJ" ? "selected" : "" ?>>New Jersey

                                    </option>

                                    <option value="NM" <?php echo $state == "NM" ? "selected" : "" ?>>New Mexico

                                    </option>

                                    <option value="NY" <?php echo $state == "NY" ? "selected" : "" ?>>New York

                                    </option>

                                    <option value="NC" <?php echo $state == "NC" ? "selected" : "" ?>>North

                                        Carolina

                                    </option>

                                    <option value="ND" <?php echo $state == "ND" ? "selected" : "" ?>>North Dakota

                                    </option>

                                    <option value="OH" <?php echo $state == "OH" ? "selected" : "" ?>>Ohio</option>

                                    <option value="OK" <?php echo $state == "OK" ? "selected" : "" ?>>Oklahoma

                                    </option>

                                    <option value="OR" <?php echo $state == "OR" ? "selected" : "" ?>>Oregon</option>

                                    <option value="PA" <?php echo $state == "PA" ? "selected" : "" ?>>Pennsylvania

                                    </option>

                                    <option value="PR" <?php echo $state == "PR" ? "selected" : "" ?>>Puerto Rico

                                    </option>

                                    <option value="RI" <?php echo $state == "RI" ? "selected" : "" ?>>Rhode Island

                                    </option>

                                    <option value="SC" <?php echo $state == "SC" ? "selected" : "" ?>>South

                                        Carolina

                                    </option>

                                    <option value="SD" <?php echo $state == "SD" ? "selected" : "" ?>>South Dakota

                                    </option>

                                    <option value="TN" <?php echo $state == "TN" ? "selected" : "" ?>>Tennessee
                                    ...
                                    <option value="VT" <?php echo $state == "VT" ? "selected" : "" ?>>Vermont

                                    </option>

                                    <option value="USVI" <?php echo $state == "USVI" ? "selected" : "" ?>>VI U.S.

                                        Virgin Islands

                                    </option>

                                    <option value="VA" <?php echo $state == "VA" ? "selected" : "" ?>>Virginia

                                    </option>

                                    <option value="WA" <?php echo $state == "WA" ? "selected" : "" ?>>Washington

                                    </option>

                                    <option value="DC" <?php echo $state == "DC" ? "selected" : "" ?>>Washington,

                                        D.C.

                                    </option>

                                    <option value="WV" <?php echo $state == "WV" ? "selected" : "" ?>>West Virginia

                                    </option>

                                    <option value="WI" <?php echo $state == "WI" ? "selected" : "" ?>>Wisconsin

                                    </option>

                                    <option value="WY" <?php echo $state == "WY" ? "selected" : "" ?>>Wyoming
                            ...
                            <input name="zip" id="zip" type="text" class="small-field"

                                   value="<?php echo sanitize( $zip ); ?>" onkeyup="checkFieldBack(this);"/>
                            ...
                            <input name="email" id="email" type="text" class="long-field"
                                   ...
                                   value="<?php echo sanitize( $email ); ?>" onkeyup="checkFieldBack(this);"/>
