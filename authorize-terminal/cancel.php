                ...
                if(strtolower(substr($code,0,1))=="e"){
                    ...
                    $mess = '<div class="ui-widget"><div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">'.$my_status.'</div></div><br />';
                               ...
                               // die("Connection failed: " . $conn->connect_error);
                                ...
                                //    UPDATE `transactions` SET `status` = 'cancel' WHERE `transactions`.`id` = 3;
                                $sql = "UPDATE transactions SET `status` = 'cancel' WHERE trans_id = ".$subid;
                    ...
                    $my_status .= "<a href='/'>Return to payment page</a></div><br/>";
