...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	//	print_r($data);exit;
    	...
    	*/
		...
		$headers = array ('Authorization: key=' . "AAAAPVmOpZo:APA91bGCBEMyPJkeBoyYlG2BcbTKK5nwOBWx6EqdPr40NP_F7GyGOlNmbMbgvl59e1QVhD6vDaD69AdK2EqCdSZLcpn1B1sYM0aVkBcGFQ7e40PBL6G6WsktGARd26nH7zuWR6iqlpsRdelete",'Content-Type: application/json');
	...
	function send_user_notification_ios($device_token, $data)
	{
        ...
        stream_context_set_option($ctx, 'ssl', 'local_cert',"help.pem");
