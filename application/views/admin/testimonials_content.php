...
<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header"><h5 class="card-header-text">Testimonials Content</h5>
          </div>
        <div class="card-block">
          <form id="edit_term" method="post">
                 <div class="form-group row">
            <label for="example-tel-input" class="col-xs-2 col-form-label form-control-label">Logo</label>
                    <div class="col-sm-10  validate-file1">
                        <input class="form-control" type="file"  name="image_logo" onchange="validateLogo1()" id="customFile2" accept='image/*'>
                        <!--<span><b>Note :</b>Image Dimensions must be 470*470.</span>-->
                         
                    </div>
                </div>
                <?php if((@$terms[0]['image_logo'] != '')){ ?>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label form-control-label"></label>
                    <div class="col-sm-10">
                        <img src="<?php echo base_url().@$terms[0]['image_logo']?>" width="100px" height="100px" style="background-color:gray;" >
            ...
            <label for="example-tel-input" class="col-xs-2 col-form-label form-control-label">Image</label>
                    <div class="col-sm-10  validate-file1">
                        <input class="form-control" type="file"  name="image_t" onchange="validateLogo()" id="customFile1" accept='image/*'>
                        <!--<span><b>Note :</b>Image Dimensions must be 470*470.</span>-->
                         
                    </div>
                </div>
                <?php if((@$terms[0]['image_t'] != '')){ ?>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label form-control-label"></label>
                    <div class="col-sm-10">
                        <img src="<?php echo base_url().@$terms[0]['image_t']?>" width="100px" height="100px" style="background-color:gray;" >
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="data[title_t]" value="<?php echo @$terms[0]['title_t']; ?>" placeholder="Title">
                </div>
                </div>
                   <div class="form-group row">
                  <label class="col-xs-2 col-form-label form-control-label"> Description<span class="required">&nbsp;</span></label>
                    <div class="col-md-10">
                    <textarea class="form-control ckeditor" id="editor1" name="data[description_t]" cols="5" rows="8" id=""><?php echo @$terms[0]['description_t'];?></textarea>
                  </div>
                </div> 
		 ...
		 <input type="hidden" name="image_t" value="<?php echo @$terms[0]['image_t']; ?>">
		  <input type="hidden" name="image_logo" value="<?php echo @$terms[0]['image_logo']; ?>">
    ...
    $('.edit_term').click(function(){     
        var validator = $("#edit_term").validate();       
            ...
            if(validator.form() == true){     
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_testimonials_content",
                    type: "POST",
                    data: data,
