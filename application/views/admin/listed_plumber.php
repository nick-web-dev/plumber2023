  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" name="search_data"  id="search_data" placeholder="Username/email/phone number" value="<?php echo @$value['name'] ?>" style="width: 229px;">
        <!--<input type="text" class="form-control" name="page_number"  id="page_number" placeholder="Page number" value="<?php echo @$value['name'] ?>" style="width: 229px;" onchange="check_pageno(this.value)">-->
          <button class="search" type="submit" style="background-color: #ffd600!important;;height: 36px;"><i class="fa fa-search"></i> Search</button>
      ...
      <div class="col-md-12 form-inline">
        ...
        <!--<input type="text" class="form-control" name="search_data"  id="search_data" placeholder="Username/email/phone number" value="<?php echo @$value['name'] ?>" style="width: 229px;">-->
        <input type="text" class="form-control" name="page_number"  id="page_number" placeholder="Page number" value="<?php echo @$value['name'] ?>" style="width: 229px;" onchange="check_pageno(this.value)">
          <button class="search"  style="background-color: #ffd600!important;;height: 36px;"><i class="fa fa-search"></i> Search</button>
              ...
              <form class="form-inline" method = "post" action="<?php echo base_url(); ?>admin/listed_plumber">
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="page_count"  style="width: 229px;" >
                              <option <?php if($page_count_get == 20) {echo "selected";} ?> value="20">20</option>
                              <option <?php if($page_count_get == 100) {echo "selected";} ?> value="100">100</option>
                              <option <?php if($page_count_get == 200) {echo "selected";} ?> value="200">200</option>
                              <option <?php if($page_count_get == 500) {echo "selected";} ?> value="500">500 </option>
                          </select>
                          <button class="search" type="submit" style="background-color: #ffd600!important;;height: 36px;"><i class=""></i> Load Rows</button>
