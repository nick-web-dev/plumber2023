	...
	<nav class="vs_responsive_navbar ">
  		...
  		<div class="vs_logo">
  			...
  			<a href="<?php echo base_url();?>">
                ...
                <img src="<?php echo base_url(); ?>assets/website/img/new_logo.png" class="vs_full_logo img-fluid" alt="calltheplumber-logo">

                <img src="<?php echo base_url(); ?>assets/website/img/new_logo.png" class="vs_sticky_logo img-fluid" alt="calltheplumber-logo">
      	...
      	<div class="vs_inner-width">
          	...
          	<div class="vs_menu_list2">
                ...
                <div class="vs_menu_logo">
                  	...
                  	<img src="<?php echo base_url() ?>assets/website/img/calltheplumbeD05aR12aP01ZL-Madison12a.png" class="img-fluid" width="150px"  alt="call-the-plumber-logo">
