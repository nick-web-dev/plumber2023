	...
	<nav class="vs_responsive_navbar ">
  		...
  		<div class="vs_logo">
  			...
  			<a href="<?php echo base_url();?>">
                  ...
                  <img src="<?php echo base_url().$footer_content['image']; ?>" alt="Plumber-Logo" class="vs_full_logo img-fluid">

                <img src="<?php echo base_url(); ?>assets/website/img/plumberlogo3.png" class="vs_sticky_logo img-fluid" alt="Plumber Logo">
