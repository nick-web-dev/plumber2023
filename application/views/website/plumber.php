                ...
                <div class="col-md-9 col-sm-12">
                  <div class="">
                    ...
                    <div class="d-md-flex">
                      ...
                      <button type="button" id="add_banners1_<?php echo $key; ?>" class="btn add_banners1 mb-0 mt-1 call-button" data-key="<?php echo $key; ?>" data-id="<?php echo base64_encode($plumb['user_id']); ?>" data-phone="<?= $plumb['country_code'] . $plumb['mobile_no'] ?>"><span>Call this Plumber</span></button>
...
$(".plumber_profile").click(function (e) {
    e.preventDefault();
   var id = $(this).data("id");    var url12 = $(this).data("url");
    $.ajax({
        type: "POST",
