<?php
/******************************************************************************
#                      PHP Authorize.net Payment Terminal v2.2
#******************************************************************************
...
<?php include "includes/javascript.validation.php"; ?>
    ...
    <div class="form_container">
        ...
        <form id="ff1" name="ff1" method="post" action="" enctype="multipart/form-data"
            onsubmit="return <?php if($enableReCaptcha){?> false <?php }else{?>checkForm();<?php }?>" class="pppt_form">
            <div id="accordion">
                <?php if($show_form){ ?>
            	<!-- PAYMENT BLOCK -->
                ...
                <div class="pane" style="display:block">
                    <?php if($show_services || $payment_mode=="RECUR"){
                        ...
                        <input name="item_description" id="item_description" type="text" class="long-field"  value="<?php echo sanitize($item_description);?>" onkeyup="checkFieldBack(this);" />
                        <div class="clr"></div>
                        <label>Amount:</label>
                ...
                <div class="pane">
                    ...
                    <input name="fname" id="fname" type="text" class="long-field"  value="<?php echo sanitize($fname);?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div>

                     <label>Last Name:</label>
                    <input name="lname" id="lname" type="text" class="long-field"  value="<?php echo sanitize($lname);?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div>

                     <label>Address:</label>
                    <input name="address" id="address" type="text" class="long-field"  value="<?php echo sanitize($address);?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div>

                     <label>City:</label>
                    <input name="city" id="city" type="text" class="long-field"  value="<?php echo sanitize($city);?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div>
                    ...
                    <input name="zip" id="zip" type="text" class="small-field"  value="<?php echo sanitize($zip);?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div>

                     <label>E-mail:</label>
                    <input name="email" id="email" type="text" class="long-field"  value="<?php echo sanitize($email);?>" onkeyup="checkFieldBack(this);" />
                    <div class="clr"></div>
                </div>
                <!-- BILLING BLOCK -->
                   ...
                   <span class="card-cont">
                    ...
                    <input name="cctype" type="radio" value="D" class="lft-field"/> <img src="images/ico_disc.jpg" align="absmiddle" class="lft-field cardhide D"/>
                        ...
                        <?php if ($enable_paypal) { ?>
                            <span class="card-cont">
                        <input name="cctype" type="radio" value="PP" class="lft-field isPayPal"/> <img src="images/ico_paypal.png" width="37" height="11" align="absmiddle"
                        ...
                        <div class="ccinfo">
                            ...
                            <input name="ccn" id="ccn" type="text" class="long-field" onkeyup="checkNumHighlight(this.value);checkFieldBack(this);noAlpha(this);" value=""
                                   onkeypress="checkNumHighlight(this.value);noAlpha(this);" onblur="checkNumHighlight(this.value);" onchange="checkNumHighlight(this.value);" maxlength="16"/>
                        ...
                        <?php if ($enableReCaptcha) { ?>
                            <div class="g-recaptcha" data-sitekey="<?php echo($reCaptcha_siteKey) ?>" data-callback="checkCaptcha"></div>
                        <?php } ?>

                        <div class="submit-btn">
                            <input src="images/btn_submit.jpg" type="image" name="submit" <?php if ($enableReCaptcha){ ?>disabled<?php } ?>/>
                        </div>
