                        ...
                        */
                        ...
                        if(strtolower(substr($code,0,1))=="e"){
                            ...
                            ******************************************************************/
                            ...
                            $message .= "If for any reason you need to cancel this subscription you can follow <a href='http://".$_SERVER["SERVER_NAME"].(stristr($_SERVER["REQUEST_URI"],"index.php")? str_replace("index.php","cancel.php",$_SERVER["REQUEST_URI"]) : "cancel.php").(stristr($_SERVER["REQUEST_URI"],"?")?"&subid=":"?subid=").$subscriptionId."'>this link</a><br />";
                            mail($admin_email,$subject,$message,$headers);
